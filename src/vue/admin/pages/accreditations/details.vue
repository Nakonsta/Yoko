<template>
  <div class="accreditation-details">
    ...
    <div
      v-if="!viewType.isEmpty && !loading"
      class="accreditation-details__wrapper"
    >
      ...
      <div class="accreditation-details__content">
        <accreditation-details-card
          ...
          :is-accepted="accreditation.agreement"
          :disabled="!viewType.isCreate"
          :has-error="errors.agreement"
          @on-agree="
        ...
        <accreditation-details-card
          ...
          pdf="/content/sample.pdf"
          :is-accepted="accreditation.rnp"
          :disabled="!viewType.isCreate"
          :has-error="errors.rnp"
          @on-agree="
        ...
        <accreditation-details-select
          :default-company-id="accreditation.company_id"
          :disabled="!viewType.isCreate"
          :has-error="errors.noCompany"
          @on-select="onSelect"
        />

        <div class="accreditation-details__title">
          Аккредитовать как:
        </div>
        <div class="accreditation-details__checkboxes">
          <accreditation-details-checkbox
            ...
            :disabled="!viewType.isCreate"
            :has-error="errors.noAccreditationType"
            @click="
        ...
        <div
          v-if="fileLabels"
          class="accreditations-details__files"
        >
          <accreditation-details-file-uploader
            ...
            :file-name="accreditation.documents.length ? accreditation.documents[key].file.name : ''"
            :file-url="accreditation.documents.length ? accreditation.documents[key].file.url : ''"
            :accepted="accreditation.documents.length ? accreditation.documents[key].file.accepted : null"
            :show-status="viewType.isEdit"
            :disabled="viewType.isView || (viewType.isEdit && accreditation.documents[key].file.accepted)"
            :has-error="errors.files[label.id]"
      ...
      <div
        v-if="accreditation.comment"
        class="accreditation-details__comment"
      >
    ...
    <accreditation-details-empty v-if="!loading && viewType.isEmpty" />
  </div>
</template>
<script>
