<template>
    <div class="accreditations__search">
        <input
            type="text"
            placeholder="Поиск"
            :value="search"
            @input="handleSearch($event.target.value)"
            class="accreditations__search-input"
        />

        <svg
            class="accreditations__search-icon"
            width="20"
            height="20"
            viewBox="0 0 24 24"
...
.accreditations__search {
    flex: 1;
    position: relative;
}

.accreditations__search-input {
    width: 100%;
    outline: none;
    border: none;
