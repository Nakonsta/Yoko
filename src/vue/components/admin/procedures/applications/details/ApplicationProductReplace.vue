<template>
  <div
    id="application-product-replace"
    class="popup"
  >
    <div class="popup__body">
      <div class="product-replace popup__content">
        ...
        <div class="product-replace__content">
          <application-title
            title="Замена позиций на аналоги"
            margin="0 0 32px 0"
          />
          ...
          <div class="product-replace__buttons">
            ...
            <button
              class="product-replace__button product-replace__button--cancel"
              @click="closeModal"
            >
              Отменить
            </button>
...
export default {
  name: 'ApplicationProductReplace',
  components: {
    ApplicationTitle,
    SelectInput,
    TextInput,
