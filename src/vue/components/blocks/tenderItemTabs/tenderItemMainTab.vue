  ...
  <div class="tender-item__tab-inner">
    <div class="tender-item__tab-block">
      ...
      <div class="tender-item__tab-rows">
        <div
          v-if="tenderItemData.publication_date"
          class="tender-item__tab-row"
        >
    ...
    <div
      v-if="tenderItemData.purchase_subject"
      class="tender-item__tab-block"
    >
      <div class="tender-item__tab-title">
        Предмет закупки
      </div>
      <div class="tender-item__tab-rows">
        <div
          v-if="tenderItemData.purchase_subject.description"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.purchase_subject.start_price"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
    ...
    <div
      v-if="tenderItemData.purchase_subject && tenderItemData.purchase_subject.lot_amounts"
      class="item__block"
    >
      <procedureLots
        :procedure="tenderItemData"
        :columns="{
          name: 'Наименование',
          quantity: 'Длина',
          measure: 'Единица',
    ...
    >
      <div class="tender-item__lots-block">
        <div class="tender-item__lots-rows">
          <div
            v-for="(lot, index) in tenderItemData.purchase_subject.lot_amounts"
            :key="index"
            class="tender-item__lot"
          >
            ...
            <div class="tender-item__lot-table">
              ...
              <div class="tender-item__lot-products">
                <div
                  v-for="(product, key) in filterProductsToLots(tenderItemData.purchase_subject.products, index + 1)"
                  :key="key"
                  class="tender-item__lot-product-row"
                >
                  <div
                    class="tender-item__lot-product tender-item__lot-name"
                    :data-name="product.marksize_id ? 'Наименование' : ''"
                  >
                    {{ product.name }}
                  </div>
                  <div
                    class="tender-item__lot-product tender-item__lot-length"
                    :data-name="product.quantity ? 'Длина' : ''"
                  >
                    {{ product.quantity }}
                  </div>
                  <div
                    class="tender-item__lot-product tender-item__lot-measure"
                    :data-name="product.measure ? 'Единица' : ''"
                  >
                    {{ getMeasure(product.measure) }}
                  </div>
                  <div
                    class="tender-item__lot-product tender-item__lot-sum"
                    :data-name="product.price_for_one ? 'Сумма за позицию' : ''"
                  >
                    {{ formatPriceWithCurrency(product.amount_per_position, product.currency) }}
                  </div>
                  <div
                    class="tender-item__lot-product tender-item__lot-vat"
                    :data-name="product.vat ? 'НДС' : ''"
                  >
                    {{ product.vat }} %
                  </div>
                  <div
                    class="tender-item__lot-product tender-item__lot-analogue"
                    data-name="Аналог"
                  >
    ...
    <div class="tender-item__tab-block">
      <div
        v-if="tenderItemData.payment_and_delivery"
        class="tender-item__tab-title"
      >
      ...
      <div class="tender-item__tab-rows">
        ...
        <div
          v-if="tenderItemData.payment_and_delivery && tenderItemData.payment_and_delivery.payment_info"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.payment_and_delivery && tenderItemData.payment_and_delivery.delivery_terms"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
            Условия поставки
        ...
        <div
          v-if="tenderItemData.purchase_term && tenderItemData.purchase_term.delivery_to"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
            Дата поставки
        ...
        <div
          v-if="tenderItemData.payment_and_delivery && tenderItemData.payment_and_delivery.delivery_address"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
            Место поставки
    ...
    <div
      v-if="tenderItemData.purchase_term"
      class="tender-item__tab-block"
    >
      <div class="tender-item__tab-title">
        Сроки конкурса
      ...
      <div class="tender-item__tab-rows">
        <div
          v-if="tenderItemData.purchase_term.contract_conclusion_from || tenderItemData.purchase_term.contract_conclusion_to"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
      ...
      <div class="tender-item__tab-rows">
        <div
          v-if="tenderItemData.purchase_term.delivery_from || tenderItemData.purchase_term.delivery_to"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
    ...
    <div
      v-if="tenderItemData.purchase_term || tenderItemData.summarizing"
      class="tender-item__tab-block"
    >
      <div class="tender-item__tab-title">
      ...
      <div class="tender-item__tab-rows">
        <div
          v-if="tenderItemData.purchase_term.application_end_date"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.summarizing && tenderItemData.summarizing.competition_commission"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.summarizing && tenderItemData.summarizing.documentation_receipt_date"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.summarizing && tenderItemData.summarizing.documentation_receipt_place"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.summarizing && tenderItemData.summarizing.application_consideration_date"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.summarizing && tenderItemData.summarizing.application_consideration_place"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.summarizing && tenderItemData.summarizing.summing_up_date"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
        ...
        <div
          v-if="tenderItemData.summarizing && tenderItemData.summarizing.summing_up_place"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
    ...
    >
      ...
      <div class="tender-item__tab-rows">
        <div
          v-if="tenderItemData.addition_information"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
    ...
    <div
      v-if="tenderItemData.documents && tenderItemData.documents.length"
      class="tender-item__tab-block"
    >
      <div class="tender-item__tab-title">
      ...
      <div class="tender-item__tab-rows">
        <div class="tender-item__tab-row">
          ...
          <div class="tender-item__tab-row-value">
            <div
              v-for="(item, key) in tenderItemData.documents"
              :key="key"
              class="tender-item__tab-row-file"
            >
              <a
                :href="item.url"
                class="tender-item__tab-row-link"
                download
              >
                <svg
                  class="tender-item__tab-row-svg"
                  width="13"
                  height="14"
                  viewBox="0 0 13 14"
                  fill="none"
    ...
    <div
      v-if="tenderItemData.additional_fields && tenderItemData.additional_fields.length"
      class="tender-item__tab-block"
    >
      <div class="tender-item__tab-title">
        Дополнительные поля
      ...
      <div class="tender-item__tab-rows">
        <div
          v-for="(item, key) in tenderItemData.additional_fields"
          :key="key"
          class="tender-item__tab-row"
        >
          <div class="tender-item__tab-row-name">
...
export default {
  ...
  methods: {
    ...
    filterProductsToLots(products, lotNumber) {
      const filteredProducts = products.filter((product) => product.lot == lotNumber);
