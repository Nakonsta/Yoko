      ...
      >
        <div class="companies__item-head">
          <div
            ...
            :class="{'companies__item-logo--empty': !item.logo}"
          >
            <img
              v-if="item.logo"
              :src="item.logo"
          ...
          <ul class="companies__item-rating">
            <li title="Индекс активности">
              <svg class="sprite-time"><use
                xmlns:xlink="http://www.w3.org/1999/xlink"
                xlink:href="\./img/sprite.svg#time"
              /></svg>
            ...
            <li title="Надежность компании">
              <svg class="sprite-fav"><use
                xmlns:xlink="http://www.w3.org/1999/xlink"
                xlink:href="\./img/sprite.svg#fav"
              /></svg>
              {{ item.rating || 0 }}
            </li>
          </ul>
        ...
        <dl v-if="showCounters && item.buyer">
          ...
          <dd>
            ...
            >
              {{
                formatPriceWithCurrency(amount.value || 0, amount.currency, true)
              }}{{
                index < item.amounts.length - 1 ? ', ' : ''
              }}
            </template>
          </dd>
