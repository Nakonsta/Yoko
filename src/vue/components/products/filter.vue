<template>
    <div class="products__filter">
        <ValidationObserver ref="form" tag="div" mode="eager">
            <form class="products__filter-form">
                <div class="products__filter-items">
                    <template v-if="companies === false">
                        <div class="products__filter-item products__filter-item--search">
                            <span class="products__filter-label">Маркоразмер</span>
                            <div class="search">
                                ...
                                <div class="search__input">
                                    <multiselect
                                            ...
                                            :preserveSearch="true"
                                            @select="selectMarksize"
                                            @search-change="searchMarksize"
                                    >
                    ...
                    <template v-else>
                        <div class="products__filter-item products__filter-item--search">
                            <span class="products__filter-label">Компания</span>
                            <div class="search">
                                <div class="search__input">
                                    <multiselect
                    ...
                    <div class="products__filter-item">
                        <span class="products__filter-label">Остаток, м</span>
                        <div class="products__filter-flex">
                    ...
                    <div class="products__filter-item">
                        <span class="products__filter-label">Цена, &#8381;</span>
                        <div class="products__filter-flex">
                ...
                <div class="products__filter-buttons">
                    <a href="#" class="products__filter-apply" @click="changeFilter">Применить</a>
                    <a href="#" class="products__filter-reset" @click="resetFilter">Сбросить</a>
                </div>
            </form>
        </ValidationObserver>
    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            selectMarksize(value) {
                // window.location.href = value.url
            },
            searchMarksize(string) {
            ...
            resetFilter(evt) {
                ...
                this.$emit('resetFilter', this.filtersData);
            }
        }
    }
</script>
