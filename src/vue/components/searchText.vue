<template>
    <div :class="{search: true, 'search--opened': isOpened}" v-on-clickaway="hideAutocomplete">
...
<style lang="scss" scoped>
    ...
    .search {
        ...
        &__input {
            @at-root {
                input#{&} {
                    ...
                    border: 0;
                    border-radius: rem(6px);
                    padding: rem(16px) rem(220px) rem(14px) rem(52px);
                    width: 100%;
                    height: rem(52px);
                    font-size: rem(14px);
                    line-height: (22/14);
                    ...
                    .search--opened & {
                        border-radius: rem(6px) rem(6px) rem(6px) 0;
                    }
        ...
        &__list {
            ...
            a {
                display: block;
                padding: rem(8px) rem(20px) rem(8px) rem(52px);
                color: #35495e;
            }
            a {
                white-space: nowrap;
