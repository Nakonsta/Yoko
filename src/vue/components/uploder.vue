    ...
    <div class="uploader">
        <div v-show="!files.length">
            ...
            <div class="uploader__file" @dragover="hightlight" @dragenter="hightlight" @hightleave="unhightlight" @dragend="unhightlight" @drop="drop">
                ...
                <div class="ploader__file-title">Перетащите файл в область {{extensions}}</div>
                <div class="uploader__file-or">или</div>
                <label class="uploader__file-btn btn btn--bdr">
                    Загрузите файл
                    <input type="file" :name="name" :value="value" @input="$emit('input', $event.target.value)" :accept="extensions.length ? extensions : null" @change="change($event)" :multiple="multiple ? 'multiple' : null"/>
                </label>
