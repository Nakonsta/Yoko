  ...
  <div class="registration">
    <div class="stepper">
      <div class="stepper-header">
        <div class="stepper-point" :class="{complete: step > 0}"></div>
        <div class="stepper-point" :class="{complete: step > 1}"></div>
        <div class="stepper-point" :class="{complete: step > 2}"></div>
      </div>
